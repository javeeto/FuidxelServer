 ...
 */
require_once '../../administracion/controlador/controlGestionEscaner.php';
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <script src="../../administracion/vista/js/tablaGestionEscaner.js"></script>
    </head>
    <body>
        <?php require_once '../../plantilla/vista/menu.php'; ?>
        <div class="container">
            <h2>Gestion Escaner</h2>
            ...
            <div class="tab-content">
                    ...
                    <form class="form-horizontal" method="post">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group <?= $panelGeneral["errorEscanerHtml"] ?>">
                                    <?= $panelGeneral["nombreEscanerHtml"] ?>
                                </div>
                                <div class="form-group <?= $panelGeneral["errorDispositivoHtml"] ?>">
                                    <?= $panelGeneral["nombreDispositivoHtml"] ?>
                                </div>
                                <div class="form-group <?= $panelGeneral["erroripHtml"] ?>">        
                                    <?= $panelGeneral["nombreipHtml"] ?>
                                </div>
                                <div class="form-group <?= $panelGeneral["errordirHtml"] ?>">        
                                    <?= $panelGeneral["nombredirHtml"] ?>
                                </div>   
                                <div class="form-group <?= $panelGeneral["errorsitioHtml"] ?>">        
                                    <?= $panelGeneral["nombresitioHtml"] ?>
                                </div>    
                                <div class="form-group <?= $panelGeneral["errortipoHtml"] ?>">        
                                    <?= $panelGeneral["nombretipoHtml"] ?>
                                </div> 
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">Datos Configuracion</div>
                            <div class="panel-body">

                                <?php for ($i = 0; $i < count($panelConfiguracion["errorHtml"]); $i++) { ?>

                                    <div class="form-group <?= $panelConfiguracion["errorHtml"][$i] ?>">
                                        <?= $panelConfiguracion["campoHtml"][$i] ?>
                                    </div>
                ...
                <div id="listado" class="tab-pane fade ">
                    <table id="tablaEscaner" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombre</th>
